...
from compressor.train import (
    tokenize_batch, combined_loss, exec_distance,
)
from datagen import produce_batch, random_instruction
...
class TestTrainingSmoke:
    ...
    def test_evaluate_after_training(self, tmp_path):
        ...
        eval_batches = [produce_batch(8, 4, np.random.default_rng(99))]
        evaluate(str(run_dir), batches=eval_batches)
